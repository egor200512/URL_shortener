...
func ProvideLinksService(repo lr.ILinksRepo, cache cache.ICache, producer broker.IProducer, cfg configs.IJwtConf) ls.ILinksService {
	return lsi.NewLinksService(repo, cache, producer, cfg)
}
